    ...
    var s = (function(e, r) {
        ...
        if (u) {
            ...
            (v = l ? o.default.dirname(v) + "/" : __dirname + "/"),
                ...
                (p = e => {
                    var r = d(e, !0);
                    return r.buffer || (r = new Uint8Array(r)), D(r.buffer), r;
                }),
                (f = (e, r, t) => {
                    g(),
                        (e = h.normalize(e)),
            ...
            "undefined" != typeof read &&
                ...
                (p = function(e) {
                    ...
                    return "function" == typeof readbuffer
                        ...
                        : ((r = read(e, "binary")), D("object" == typeof r), r);
                }),
                (f = function(e, r, t) {
                    setTimeout(() => r(p(e)), 0);
                }),
                      ...
                      null === ce &&
                          ...
                          (ce = setInterval(function() {
                              ...
                              for (var r in fe)
                                  e ||
                                      ((e = !0),
                                      _("still waiting on run dependencies:")),
                                      _("dependency: " + r);
                              e && _("(end of list)");
                          }, 1e4)))
        ...
        function he(e) {
            if (
                ...
                0 == ue &&
                    (null !== ce && (clearInterval(ce), (ce = null)), de))
            ) {
                var t = de;
                (de = null), t();
            }
            ...
            return function() {
                ...
                return (
                    ...
                    o[e] ||
                        D(
                            o[e],
                            "exported native function `" + n + "` not found"
                        ),
        ...
        var Ae = {
            ...
            basename: e => {
                if ("/" === e) return "/";
                var r = (e = (e = Ae.normalize(e)).replace(
                    /\/$/,
                    ""
                )).lastIndexOf("/");
        ...
        var De = {
                ...
                relative: (e, r) => {
                    ...
                    (e = De.resolve(e).substr(1)),
                        (r = De.resolve(r).substr(1));
                    for (
                        var n = t(e.split("/")),
                            o = t(r.split("/")),
            ...
            Oe = {
                ...
                register: function(e, r) {
                    (Oe.ttys[e] = { input: [], output: [], ops: r }),
                        Ie.registerDevice(e, Oe.stream_ops);
                },
                stream_ops: {
                    open: function(e) {
        ...
        function Fe(e) {
            e = (function(e, r) {
                return (
                    D(r, "alignment argument is required"), Math.ceil(e / r) * r
                );
            })(e, 65536);
            var r = bt(65536, e);
            return r
        ...
        var Me = {
            ...
            node_ops: {
                getattr: function(e) {
                    var r = {};
                    return (
                        (r.dev = Ie.isChrdev(e.mode) ? e.id : 1),
                        (r.ino = e.id),
                        (r.mode = e.mode),
                        (r.nlink = 1),
                        (r.uid = 0),
                ...
                setattr: function(e, r) {
                    void 0 !== r.mode && (e.mode = r.mode),
                        ...
                        void 0 !== r.size && Me.resizeFileStorage(e, r.size);
                },
                lookup: function(e, r) {
            ...
            stream_ops: {
                ...
                llseek: function(e, r, t) {
                    ...
                    if (
                        ...
                        throw new Ie.ErrnoError(28);
                    return n;
                },
                allocate: function(e, r, t) {
                    Me.expandFileStorage(e.node, r + t),
                ...
                msync: function(e, r, t, n, o) {
                    if (!Ie.isFile(e.node.mode)) throw new Ie.ErrnoError(43);
                    return 2 & o || Me.stream_ops.write(e, r, 0, n, t, !1), 0;
                }
            }
        };
        var Re = {
            ...
            Ie = {
                ...
                lookupPath: function(e) {
                    ...
                    for (
                        ...
                        if (
                            ...
                            for (var l = 0; Ie.isLink(o.mode); ) {
                                var u = Ie.readlink(a);
                                a = De.resolve(Ae.dirname(a), u);
                                var c = Ie.lookupPath(a, {
                ...
                hashRemoveNode: e => {
                    var r = Ie.hashName(e.parent.id, e.name);
                    if (Ie.nameTable[r] === e) Ie.nameTable[r] = e.name_next;
                    else
                        for (var t = Ie.nameTable[r]; t; ) {
                            if (t.name_next === e) {
                ...
                lookupNode: (e, r) => {
                    ...
                    for (
                        var n = Ie.hashName(e.id, r), o = Ie.nameTable[n];
                        o;
                        o = o.name_next
                    ) {
                        var a = o.name;
                ...
                mayOpen: (e, r) =>
                    e
                        ? Ie.isLink(e.mode)
                            ? 32
                            : Ie.isDir(e.mode) &&
                              ("r" !== Ie.flagsToPermissionString(r) || 512 & r)
                            ? 31
                            : Ie.nodePermissions(
                                  e,
                                  Ie.flagsToPermissionString(r)
                              )
                        : 44,
                MAX_OPEN_FDS: 4096,
                nextfd: function() {
                ...
                makedev: (e, r) => (e << 8) | r,
                registerDevice: (e, r) => {
                    Ie.devices[e] = { stream_ops: r };
                },
                getDevice: e => Ie.devices[e],
                getMounts: e => {
                ...
                syncfs: (e, r) => {
                    ...
                    function o(e) {
                        return (
                            D(Ie.syncFSRequests > 0), Ie.syncFSRequests--, r(e)
                        );
                    }
                    function a(e) {
                        if (e)
                ...
                mount: (e, r, t) => {
                    ...
                    if (!o && !a) {
                        var i = Ie.lookupPath(t, { follow_mount: !1 });
                        if (((t = i.path), (n = i.node), Ie.isMountpoint(n)))
                            throw new Ie.ErrnoError(10);
                ...
                unmount: e => {
                    var r = Ie.lookupPath(e, { follow_mount: !1 });
                    if (!Ie.isMountpoint(r.node)) throw new Ie.ErrnoError(28);
                    var t = r.node,
                        n = t.mounted,
                        o = Ie.getMounts(n);
                    Object.keys(Ie.nameTable).forEach(e => {
                    ...
                    D(-1 !== a), t.mount.mounts.splice(a, 1);
                },
                ...
                mknod: (e, r, t) => {
                    ...
                    if (!o || "." === o || ".." === o)
                        throw new Ie.ErrnoError(28);
                    var a = Ie.mayCreate(n, o);
                    if (a) throw new Ie.ErrnoError(a);
                ...
                symlink: (e, r) => {
                    if (!De.resolve(e)) throw new Ie.ErrnoError(44);
                    var t = Ie.lookupPath(r, { parent: !0 }).node;
                ...
                rename: (e, r) => {
                    var t,
                        ...
                        s = Ae.basename(r);
                    if (
                        ((t = Ie.lookupPath(e, { parent: !0 }).node),
                        (n = Ie.lookupPath(r, { parent: !0 }).node),
                        !t || !n)
                    )
                        throw new Ie.ErrnoError(44);
                    if (t.mount !== n.mount) throw new Ie.ErrnoError(75);
                    var l,
                        u = Ie.lookupNode(t, i),
                        c = De.relative(e, a);
                    if ("." !== c.charAt(0)) throw new Ie.ErrnoError(28);
                    if ("." !== (c = De.relative(r, o)).charAt(0))
                        throw new Ie.ErrnoError(55);
                    try {
                        l = Ie.lookupNode(n, s);
                    } catch (e) {}
                    if (u !== l) {
                        var d = Ie.isDir(u.mode),
                            f = Ie.mayDelete(t, i, d);
                        if (f) throw new Ie.ErrnoError(f);
                        if (
                            (f = l ? Ie.mayDelete(n, s, d) : Ie.mayCreate(n, s))
                        )
                            throw new Ie.ErrnoError(f);
                        if (!t.node_ops.rename) throw new Ie.ErrnoError(63);
                        if (Ie.isMountpoint(u) || (l && Ie.isMountpoint(l)))
                            throw new Ie.ErrnoError(10);
                        if (n !== t && (f = Ie.nodePermissions(t, "w")))
                            throw new Ie.ErrnoError(f);
                        Ie.hashRemoveNode(u);
                        try {
                ...
                rmdir: e => {
                    var r = Ie.lookupPath(e, { parent: !0 }).node,
                        t = Ae.basename(e),
                        n = Ie.lookupNode(r, t),
                ...
                readdir: e => {
                    var r = Ie.lookupPath(e, { follow: !0 }).node;
                ...
                stat: (e, r) => {
                    var t = Ie.lookupPath(e, { follow: !r }).node;
                    if (!t) throw new Ie.ErrnoError(44);
                ...
                chmod: (e, r, t) => {
                    var n;
                    "string" == typeof e
                        ? (n = Ie.lookupPath(e, { follow: !t }).node)
                        : (n = e);
                ...
                chown: (e, r, t, n) => {
                    var o;
                    "string" == typeof e
                        ? (o = Ie.lookupPath(e, { follow: !n }).node)
                        : (o = e);
                ...
                truncate: (e, r) => {
                    ...
                    var t;
                    "string" == typeof e
                        ? (t = Ie.lookupPath(e, { follow: !0 }).node)
                        : (t = e);
                ...
                open: (e, t, n, o, a) => {
                    ...
                    if (
                        ...
                        e = Ae.normalize(e);
                        try {
                            i = Ie.lookupPath(e, { follow: !(131072 & t) })
                                .node;
                        } catch (e) {}
                    }
                    var s = !1;
                    if (64 & t)
                        ...
                        } else (i = Ie.mknod(e, n, 0)), (s = !0);
                    if (!i) throw new Ie.ErrnoError(44);
                    if (
                        (Ie.isChrdev(i.mode) && (t &= -513),
                        65536 & t && !Ie.isDir(i.mode))
                    )
                        throw new Ie.ErrnoError(54);
                    if (!s) {
                        var l = Ie.mayOpen(i, t);
                        if (l) throw new Ie.ErrnoError(l);
                    }
                    512 & t && Ie.truncate(i, 0), (t &= -131713);
                    ...
                    return (
                        ...
                        !r.logReadFiles ||
                            ...
                            e in Ie.readFiles || (Ie.readFiles[e] = 1)),
                        u
                    );
                },
                close: e => {
                ...
                writeFile: function(e, r) {
                    ...
                    if ("string" == typeof r) {
                        var o = new Uint8Array(I(r) + 1),
                            a = R(r, o, 0, o.length);
                        Ie.write(n, o, 0, a, void 0, t.canOwn);
                    } else {
                ...
                cwd: () => Ie.currentPath,
                chdir: e => {
                    var r = Ie.lookupPath(e, { follow: !0 });
                ...
                createDefaultDevices: () => {
                    Ie.mkdir("/dev"),
                        ...
                        Oe.register(Ie.makedev(5, 0), Oe.default_tty_ops),
                        Oe.register(Ie.makedev(6, 0), Oe.default_tty1_ops),
                ...
                createStandardStreams: () => {
                    ...
                    D(0 === e.fd, "invalid handle for stdin (" + e.fd + ")"),
                        D(
                            1 === t.fd,
                            "invalid handle for stdout (" + t.fd + ")"
                        ),
                        D(
                            2 === n.fd,
                            "invalid handle for stderr (" + n.fd + ")"
                        );
                },
                ensureErrnoError: () => {
                    Ie.ErrnoError ||
                        ((Ie.ErrnoError = function(e, r) {
                            (this.node = r),
                                (this.setErrno = function(e) {
                                    for (var r in ((this.errno = e), Ne))
                                        if (Ne[r] === e) {
                                            this.code = r;
                                            break;
                                        }
                ...
                analyzePath: (e, r) => {
                    try {
                        e = (n = Ie.lookupPath(e, { follow: !r })).path;
                    } catch (e) {}
                    var t = {
                        isRoot: !1,
                        exists: !1,
                    ...
                    try {
                        ...
                        (t.parentExists = !0),
                            ...
                            (t.name = Ae.basename(e)),
                            (n = Ie.lookupPath(e, { follow: !r })),
                            (t.exists = !0),
                            (t.path = n.path),
                            (t.object = n.node),
                            (t.name = n.node.name),
                ...
                createDevice: (e, r, t, n) => {
                    ...
                    var i = Ie.makedev(Ie.createDevice.major++, 0);
                    return (
                        Ie.registerDevice(i, {
                            open: e => {
                                e.seekable = !1;
                ...
                createPreloadedFile: (e, r, t, n, o, a, i, s, l, u) => {
                    var c = r ? De.resolve(Ae.join2(e, r)) : e,
                        d = pe("cp " + c);
                    function p(t) {
                        function f(t) {
                            u && u(),
                                s || Ie.createDataFile(e, r, t, n, o, l),
                                a && a(),
                                he(d);
                        }
                    ...
                    (o.onupgradeneeded = () => {
                        ...
                        (o.onsuccess = () => {
                            var n = o.result.transaction(
                                ...
                                a = n.objectStore(Ie.DB_STORE_NAME),
                                i = 0,
                                s = 0,
                                l = e.length;
                            function u() {
                ...
                loadFilesFromDB: (e, r, t) => {
                    ...
                    (o.onupgradeneeded = t),
                        (o.onsuccess = () => {
                            ...
                            var i = a.objectStore(Ie.DB_STORE_NAME),
                                s = 0,
                                l = 0,
                                u = e.length;
                            function c() {
                ...
                doStat: function(e, r, t) {
                    try {
                        ...
                        if (
                            e &&
                            e.node &&
                            Ae.normalize(r) !== Ae.normalize(Ie.getPath(e.node))
                        )
                            return -54;
                        throw e;
                    }
        ...
        function fr(e, r) {
            return (
                (r = (function(e, r) {
                    for (
                        void 0 === r && Ye("ptr should not be undefined");
                        e.baseClass;
        ...
        function mr(e) {
            ...
            var l = nr(r, this.registeredClass, a.registeredClass);
            return null === l
                ? o.call(this)
                : this.isSmartPointer
                ? pr(a.registeredClass.instancePrototype, {
                      ptrType: a,
                      ptr: l,
                      smartPtrType: this,
                      smartPtr: e
                      ...
                      if (!!r.smartPtr) {
                          ...
                          (t.leakWarning = new Error(
                              ...
                              "captureStackTrace" in Error &&
                                  Error.captureStackTrace(t.leakWarning, mr),
                              er.register(e, t, e);
                      }
                      return e;
                  }),
                  (rr = e => er.unregister(e)),
                  hr(e));
        }
        function gr() {
        ...
        function vr() {
            this.$$.ptr || Ze(this),
                this.$$.deleteScheduled &&
                    ...
                    Ye("Object already scheduled for deletion"),
                rr(this),
                tr(this.$$),
                this.$$.preservePointerOnDelete ||
        ...
        function kr(e, r) {
            if (null === r)
                return (
                    this.isReference && Ye("null is not a valid " + this.name),
                    0
                );
            r.$$ || Ye('Cannot pass "' + Xr(r) + '" as a ' + this.name),
                r.$$.ptr ||
                    Ye(
        ...
        function Sr(e, r) {
            ...
            if (
                ((t = Tr(r.$$.ptr, n, this.registeredClass)),
                this.isSmartPointer)
            )
                switch (
                    (void 0 === r.$$.smartPtr &&
                        Ye("Passing raw pointer to smart pointer is illegal"),
                    this.sharingPolicy)
                ) {
                    case 0:
                        r.$$.smartPtrType === this
        ...
        function Fr(e, r, t, n, o, a, i, s, l, u, c) {
            (this.name = e),
        ...
        function Mr(e, t, n) {
            return e.includes("j")
                ...
                : (D(Ce(t), "missing table entry in dynCall: " + t),
                  Ce(t).apply(null, n));
        }
        function Rr(e, r) {
            var t = (e = Be(e)).includes("j")
                ? (function(e, r) {
                      D(
                          e.includes("j"),
        ...
        function Lr(e, r) {
            ...
            throw (r.forEach(function e(r) {
                n[r] ||
                    $e[r] ||
                    (We[r] ? We[r].forEach(e) : (t.push(r), (n[r] = !0)));
            }),
        ...
        function jr(e, r, t, n, o) {
            ...
            return (
                ...
                (f += "}\n"),
                m.push(f),
                Br(Function, m).apply(null, h)
            );
        }
        function $r(e, r, t) {
            return (
                e instanceof Object || Ye(t + ' with invalid "this": ' + e),
                ...
                Tr(e.$$.ptr, e.$$.ptrType.registeredClass, r.registeredClass)
            );
        }
        var Wr = [],
            zr = [
        ...
        function Vr() {
            for (var e = 5; e < zr.length; ++e)
                if (void 0 !== zr[e]) return zr[e];
            return null;
        }
        var Yr = {
            toValue: e => (
                e || Ye("Cannot use deleted val. handle = " + e), zr[e].value
            ),
            toHandle: e => {
                switch (e) {
                    case void 0:
                    ...
                    default:
                        ...
                        return (zr[r] = { refcount: 1, value: e }), r;
                }
            }
        };
        function Xr(e) {
        ...
        var et = [];
        function rt(e, r) {
            return D(r === (0 | r)), (e >>> 0) + 4294967296 * r;
        }
        function tt(e, r) {
            if (e <= 0) return e;
        ...
        function ot(e, r) {
            ...
            for (var a, i, s, l, u, c, d = []; ; ) {
                ...
                if (((i = x[(t + 1) >> 0]), 37 == a)) {
                    ...
                    var y = 0;
                    if (42 == i) (y = o("i32")), t++, (i = x[(t + 1) >> 0]);
                    else
                        for (; i >= 48 && i <= 57; )
                            (y = 10 * y + (i - 48)), t++, (i = x[(t + 1) >> 0]);
                    var E,
                        w = !1,
                        b = -1;
                    if (46 == i) {
                    ...
                    switch (
                        (b < 0 && ((b = 6), (w = !1)), String.fromCharCode(i))
                    ) {
                        case "h":
                    ...
                    switch (
                            ...
                            if (100 == i || 105 == i)
                                ...
                                if (((S = h && 0 != s ? "0x" : ""), s < 0)) {
                                    ...
                                    for (var C = [], P = 0; P < A.length; P++)
                                        C.push(
                                            (15 - parseInt(A[P], 16)).toString(
                                                16
                                            )
                                        );
                                    for (A = C.join(""); A.length < 2 * E; )
                                        A = "f" + A;
                        ...
                        case "s":
                            ...
                            if ((w && (I = Math.min(I, b)), !m))
                                for (; I < y--; ) d.push(32);
                            if (N) for (P = 0; P < I; P++) d.push(U[N++ >> 0]);
                            else d = d.concat(pt("(null)".substr(0, I), !0));
            ...
            24 & e &&
                ...
                (r +=
                    ...
                    (function(e) {
                        ...
                        (r = r.slice(o)),
                            32 & e &&
                                T("EM_LOG_DEMANGLE is deprecated; ignoring"),
                            8 & e &&
        ...
        function st(e) {
            try {
                return (
                    w.grow((e - L.byteLength + 65535) >>> 16), Z(w.buffer), 1
                );
            } catch (r) {
                _(
        ...
        function ut() {
            if (!ut.strings) {
                ...
                for (var r in lt)
                    void 0 === lt[r] ? delete e[r] : (e[r] = lt[r]);
                var t = [];
        ...
        Object.defineProperties(ct.prototype, {
            ...
            (Ve = r.BindingError = Ge(Error, "BindingError")),
            (Xe = r.InternalError = Ge(Error, "InternalError")),
            (wr.prototype.isAliasOf = Qe),
            (wr.prototype.clone = gr),
            (wr.prototype.delete = vr),
            (wr.prototype.isDeleted = yr),
            (wr.prototype.deleteLater = Er),
            (r.getInheritedInstanceCount = ar),
            (r.getLiveInheritedInstances = ir),
            (r.flushPendingDeletes = lr),
            (r.setDelayFunction = cr),
            (Fr.prototype.getPointee = Ar),
            (Fr.prototype.destructor = Dr),
            (Fr.prototype.argPackAdvance = 8),
            (Fr.prototype.readValueFromPointer = Pr),
            (Fr.prototype.deleteObject = Or),
            (Fr.prototype.fromWireType = mr),
            (Nr = r.UnboundTypeError = Ge(Error, "UnboundTypeError")),
            (r.count_emval_handles = Gr),
            (r.get_first_emval = Vr);
        var mt = {
                    ...
                    Ke([e, t, n], o ? [o] : [], function(t) {
                        ...
                        var s = He(m, function() {
                                if (Object.getPrototypeOf(this) !== u)
                                    throw new Ve("Use 'new' to construct " + d);
                                if (void 0 === f.constructor_body)
                                    throw new Ve(
                                        d + " has no accessible constructor"
                                    );
                            ...
                            u = Object.create(a, { constructor: { value: s } });
                        s.prototype = u;
                        var f = new _r(d, s, u, p, n, i, l, c),
                            h = new Fr(d, f, !0, !1, !1),
                            g = new Fr(d + "*", f, !1, !1, !1),
                            v = new Fr(d + " const*", f, !1, !0, !1);
                        return (
                            (or[e] = { pointerType: g, constPointerType: v }),
                            (function(e, t, n) {
                                r.hasOwnProperty(e) ||
            ...
            _embind_register_class_constructor: function(e, r, t, n, o, a) {
                D(r > 0);
                var i = xr(r, t);
                (o = Rr(n, o)),
                    Ke([], [e], function(e) {
            ...
            _embind_register_class_function: function(e, r, t, n, o, a, i, s) {
                var l = xr(t, n);
                (r = Be(r)),
                    (a = Rr(o, a)),
                    Ke([], [e], function(e) {
                ...
                Je(e, {
                    ...
                    toWireType: function(e, r) {
                        if ("number" != typeof r && "boolean" != typeof r)
                            throw new TypeError(
                                'Cannot convert "' + Xr(r) + '" to ' + this.name
                            );
                        return r;
                    },
                    argPackAdvance: 8,
                    readValueFromPointer: qr(r, n),
                    destructorFunction: null
                });
            },
            _embind_register_integer: function(e, r, t, n, o) {
                ...
                Je(e, {
                    ...
                    argPackAdvance: 8,
                    readValueFromPointer: Kr(r, a, 0 !== n),
                    destructorFunction: null
                });
            },
                ...
                Je(e, {
                    ...
                    fromWireType: function(e) {
                        ...
                        if (t)
                            ...
                            var l = new Array(n);
                            for (a = 0; a < n; ++a)
                                l[a] = String.fromCharCode(U[e + 4 + a]);
                            r = l.join("");
                        }
                        return ht(e), r;
                    },
                    toWireType: function(e, r) {
                        ...
                        n ||
                            ...
                            Ye("Cannot pass non-string to std::string");
                        var o = (t && n ? () => I(r) : () => r.length)(),
                            a = gt(4 + o + 1);
                        if (((W[a >> 2] = o), t && n)) N(r, a + 4, o + 1);
                        else if (n)
                            for (var i = 0; i < o; ++i) {
                        ...
                        else for (i = 0; i < o; ++i) U[a + 4 + i] = r[i];
            ...
            _emval_take_value: function(e, r) {
                var t = (e = Jr(e, "_emval_take_value")).readValueFromPointer(
                    r
                );
        ...
        !(function() {
            var e = { env: mt, wasi_snapshot_preview1: mt };
            function t(e, t) {
                var n,
                    o = e.exports;
                (r.asm = o),
                    D((w = r.asm.memory), "memory not found in wasm exports"),
                    Z(w.buffer),
                    D(
        ...
        var wt = (r.___stdio_exit = _e("__stdio_exit")),
            bt = (r._emscripten_builtin_memalign = _e(
                "emscripten_builtin_memalign"
            )),
            _t = (r._emscripten_stack_init = function() {
                return (_t = r._emscripten_stack_init =
        ...
        var Tt,
            kt = (r._emscripten_stack_get_end = function() {
                return (kt = r._emscripten_stack_get_end =
        ...
        (s.postRun = function() {
                    ...
                    decoder: new VideoDecoder({
                        output: function(e) {
                            t.isEmitInfo ||
                                (n.opt.debug &&
                                    console.log(
                                        "Jessibuca: [worker] Webcodecs Video Decoder initSize"
                                    ),
                                postMessage({
                                    cmd: m,
                                    w: e.codedWidth,
                                ...
                                (t.offscreenCanvasCtx = t.offscreenCanvas.getContext(
                                    "2d"
                                ))),
                            ...
                            postMessage(
                                { cmd: h, buffer: r, delay: n.delay, ts: 0 },
                                [r]
                            ),
                                setTimeout(function() {
            ...
            var n = {
                    ...
                    initAudioPlanar: function(e, t) {
                        postMessage({ cmd: v, sampleRate: t, channels: e });
                        var n = [],
                            o = 0;
                        this.playAudioPlanar = function(t, a, i) {
                            for (var l = a, u = [], c = 0, d = 0; d < 2; d++) {
                                var f = s.HEAPU32[(t >> 2) + d] >> 2;
                                u[d] = s.HEAPF32.subarray(f, f + l);
                            }
                            if (o) {
                                if (!(l >= (a = 1024 - o)))
                                    return (
                    ...
                    setAudioCodec: function(e) {
                        postMessage({ cmd: y, code: e });
                    },
                    setVideoSize: function(e, r) {
                        postMessage({ cmd: m, w: e, h: r });
                        var t = e * r,
                            o = t >> 2;
                        n.useOffscreen()
                            ? ((this.offscreenCanvas = new OffscreenCanvas(
                              ...
                              (this.offscreenCanvasGL = this.offscreenCanvas.getContext(
                                  "webgl"
                              )),
                              (this.webglObj = ((e, r) => {
                                  var t = [
                                  ...
                                  var l = e.getAttribLocation(i, "vertexPos");
                                  ...
                                  var c = e.getAttribLocation(i, "texturePos");
                                  function d(r, t) {
                                  ...
                                  n.opt.openWebglAlignment
                              )),
                              (this.draw = function(a, i, l, u) {
                                  const c = s.HEAPU8.subarray(i, i + t),
                                      d = s.HEAPU8.subarray(l, l + o),
                                      f = s.HEAPU8.subarray(u, u + o);
                                  if (O(Uint8Array.from(c)))
                                      return void (
                                          n.opt.debug &&
                                          console.log(
                                              "Jessibuca: [worker]: draw offscreenCanvas is green yuv"
                                          )
                                      );
                                  this.webglObj.render(e, r, c, d, f);
                                  let p = this.offscreenCanvas.transferToImageBitmap();
                                  postMessage(
                                      {
                                          cmd: h,
                                          buffer: p,
                            ...
                            : (this.draw = function(e, r, a, i) {
                                  const l = Uint8Array.from(
                                          s.HEAPU8.subarray(r, r + t)
                                      ),
                                      u = Uint8Array.from(
                                          s.HEAPU8.subarray(a, a + o)
                                      ),
                                      c = Uint8Array.from(
                                          s.HEAPU8.subarray(i, i + o)
                                      );
                                  if (O(l))
                                      return void (
                                          n.opt.debug &&
                                          console.log(
                                              "Jessibuca: [worker]: draw is green yuv"
                                          )
                                      );
                                  const d = [l, u, c];
                                  postMessage(
                        ...
                        this.stopId = setInterval(() => {
                            if (e.length)
                                if (this.dropping) {
                                    ...
                                    var t = e[0];
                                    if (-1 === this.getDelay(t.ts))
                                        e.shift(), r(t);
                                    else if (
                                        this.delay >
                                        n.opt.videoBuffer +
                                            n.opt.videoBufferDelay
                                    )
                    ...
                    close: function() {
                        n.opt.debug &&
                            console.log("Jessibuca: [worker]: close"),
                ...
                o = new s.AudioDecoder(n),
                a = new s.VideoDecoder(n);
            postMessage({ cmd: _ }),
